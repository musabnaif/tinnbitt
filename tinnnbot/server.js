...
setInterval(() => {
  http.get(`http://tinbot-12.glitch.me/`);
}, 280000);
...
const prefix = '-'
  ...
  client.on("message", message => {  
    if(message.content.startsWith(prefix + 'crevo')) {  
...
client.on("message", message => {    
    if(message.content.startsWith(prefix + "addemg")) {   
...
client.on('message', message => {
        if (message.content.startsWith(prefix + 'طرح')) {
        var x = ["4326-2345=?",
"5822-8547=?",
"543-823=?",
"1500-500=?",
...
client.on("message", message => {
  let args = message.content.split(" ").slice(1);
    if(message.content.startsWith(prefix + 'role') || message.content.startsWith(prefix + 'تفضل') || message.content.startsWith(prefix + 'رول')) {
...
client.on("message", (message) => {
    ...
    if(message.content.startsWith(prefix + 'new') || message.content.startsWith(prefix + 'تيكيت')) {
    ...
    if(message.content.startsWith(prefix + 'close') || message.content.startsWith(prefix + 'تقفيل')) {
      ...
      if (message.author.bot) return
           message.delete();
             ...
             setTimeout(function() {
               ...
               setTimeout(function() {
               m.edit({embed: new Discord.RichEmbed().setTitle('[' + virusname + ']: يرجى انتظار ثواني 5...').setColor(0xFF0000)})
             }, 25000)
               setTimeout(function() {
               m.edit({embed: new Discord.RichEmbed().setTitle('[' + virusname + ']: يرجى انتظار ثواني 4...').setColor(0xFF0000)})
             }, 26000)
                setTimeout(function() {
               m.edit({embed: new Discord.RichEmbed().setTitle('[' + virusname + ']: يرجى انتظار ثواني 3...').setColor(0xFF0000)})
             }, 27000)
                setTimeout(function() {
               m.edit({embed: new Discord.RichEmbed().setTitle('[' + virusname + ']: يرجى انتظار ثواني 2...').setColor(0xFF0000)})
             }, 28000)
                setTimeout(function() {
               m.edit({embed: new Discord.RichEmbed().setTitle('[' + virusname + ']: يرجى انتظار ثواني 1...').setColor(0xFF0000)})
             }, 29000)
             setTimeout(function() {
...
client.on('message' , message => {
  ...
  if (message.author.bot) return;
  if (message.content.startsWith(prefix + "to-owner-bot")) {
  if (!message.channel.guild) return;
...
client.on('message', message => {
var prefix = "-";
    if(message.content.startsWith(prefix + 'lock') || message.content.startsWith(prefix + 'قفل')) {
                           if(!message.channel.guild) return message.reply('** This command only for servers**');
   ...
   if(!message.member.hasPermission('MANAGE_MESSAGES')) return message.reply(' **__ليس لديك صلاحيات__**');
    ...
    if(message.content.startsWith(prefix + 'unlock') || message.content.startsWith(prefix + 'افتح')) {
                        if(!message.channel.guild) return message.reply('** This command only for servers**');
...
client.on('message', message => {
    if (message.content.startsWith("-infobotmusabvv1")) {
    message.channel.send({
        embed: new Discord.RichEmbed()
            .setAuthor(client.user.username,client.user.avatarURL)
            .setThumbnail(client.user.avatarURL)
            .setColor('ffffff')
            .setTitle('Info Tin.Bot.')
...
client.on('message', message => {
    ...
    const embed = new Discord.RichEmbed()
    .setDescription(`**Member states🔋
🟢 online ${message.guild.members.filter(m=>m.presence.status == 'online').size}
🔴 Do Not Disturb ${message.guild.members.filter(m=>m.presence.status == 'dnd').size}
🟡 idel ${message.guild.members.filter(m=>m.presence.status == 'idle').size}   
...
client.on('message', message => {
      ...
      .setThumbnail(message.author.avatarURL)
      .setFooter(message.author.username, message.author.avatarURL)
      .setTitle('<a:pp975:750622196946436197> 『  Members info 』 <a:pp975:750622196946436197>')
      .addBlankField(true)
...
hours = 12;
  ...
  var filter = m => m.author.id === message.author.id;
    if(message.content.startsWith(prefix + 'giveaway') || message.content.startsWith(prefix + 'قيف اواي') || message.content.startsWith(prefix + 'start')) { 
    if(!message.guild.member(message.author).hasPermission('MANAGE_GUILD')) return message.channel.send(':heavy_multiplication_x:| **يجب أن يكون لديك خاصية التعديل على السيرفر**');
    message.channel.send(`| **اكتب اسم روم القيفاواي**`).then(msg => {
      message.channel.awaitMessages(filter, {
        ...
        msg.edit('| **كم تريد وقت القيفاواي**').then(msg => {
          message.channel.awaitMessages(filter, {
            max: 1,
            time: 20000,
            errors: ['time']
            ...
            collected.first().delete();
            msg.edit('| **ما هي الجائزة؟**').then(msg => {
              message.channel.awaitMessages(filter, {
                max: 1,
                time: 20000,
                errors: ['time']
                ...
                try {
                  ...
                  .setFooter(message.author.username, message.author.avatarURL);
                  message.guild.channels.find("name" , room).send(' :heavy_check_mark: **تم صنع القيفاواي** :heavy_check_mark:' , {embed: giveEmbed}).then(m => {
                     let re = m.react('🎉');
                     setTimeout(() => {
                ...
                message.channel.send(`| **ليست لدي الصلاحيات الكافية**`);
                 console.log(e);
               }
             });
           });
...
client.on('guildCreate', guild => {
  var embed = new Discord.RichEmbed()
  .setColor(0x5500ff)
  .setDescription(`**شكراً لإضافة البوت الى سيرفرك**`)
...
client.on('message' , message => {
    ...
    if(message.content.startsWith(prefix + 'unban') || message.content.startsWith(prefix + 'فك')) {        if(!message.member.hasPermission('ADMINISTRATOR')) return message.channel.send('❌|**\`ADMINISTRATOR\`لا توجد لديك رتبة`**');
...
message.channel.send(embed)
 ...
 let array_of_mentions = message.mentions.users.array();
  ...
  if (array_of_mentions.length == 1 || array_of_mentions.length == 2) {
    ...
    .catch(console.error);
    message.channel.send('يجب الانتظار حيث ما يتم الموافقه')
    ...
    .then(collected => {
      ...
      msg.edit('📜 **| هل ستحترم القوانين؟... ✏ **').then(msg => {
          ...
          .then(collected => {
            ...
            msg.edit('🤵 **| ما اسم رتبة البيع التى تريد الحصول عليها ولماذا؟... ✏ **').then(msg => {
...
${message.author.id}`);
   ...
   client.on('message', message => {
	var prefix = "-";
    if(message.content.startsWith(prefix + 'mvall') || message.content.startsWith(prefix + 'سحب الكل')) {     if (!message.member.hasPermission("MOVE_MEMBERS")) return message.channel.send('**:x: You Dont Have Perms `MOVE_MEMBERS`**');
       if(!message.guild.member(client.user).hasPermission("MOVE_MEMBERS")) return message.reply("**:x: I Dont Have Perms `MOVE_MEMBERS`**");
    if (message.member.voiceChannel == null) return message.channel.send(`**You Have To Be In Room Voice**`)
     var author = message.member.voiceChannelID;
     var m = message.guild.members.filter(m=>m.voiceChannel)
...
client.on('message', message => {    
  ...
  client.on("message", function(message) {
   ...
   if(message.content.startsWith(prefix + "help")) {
    ...
    .setAuthor(message.author.username)
    .setThumbnail(message.author.avatarURL)
    .addField("Public | عامة","💡",true)
    .addField("Admin | ادمنية","⚙",true)    
    .addField("Games | العاب","🎯",true)
      .setDescription(`
[server support](https://discord.gg/tCeK9wh) | [invite bot](https://discord.com/api/oauth2/authorize?client_id=747949575934967808&permissions=8&scope=bot)
`)
    message.channel.send(RpsEmbed).then(msg => {
        msg.react('💡')
        msg.react("⚙")
...
reaction1.on("collect", r => {
  const embed = new Discord.RichEmbed()
      .setThumbnail('https://media.discordapp.net/attachments/756523338259759225/765325522674122812/image3.png?width=481&height=481')
      .setColor("BALCK")
      .setDescription(`
    ✅***__ اوامر عامة | General orders  __***✅ 
**
〘 ${prefix}ping ====> لمعرفة سرعة اتصال البوت
〘 رابط ====> يسويلك رابط لمدة يوم وعدد الاستخدامات 100 〙
〘 ${prefix}tag ====> لعرض الكلام بشكل جميل و كبير 〙
〘 ${prefix}quran ====> لعرض 200 صفحة من القرآن الكريم 〙
〘 ${prefix}perms ====> لعرض صلاحياتك 〙
〘 ${prefix}top-inv ====> لعرض صاحب اكثر دعوات 〙
〘 ${prefix}to-owner-bot ====> للتواصل مع صاحب البوت 〙
〘 ${prefix}report ====> للابلاغ عن احد 〙
〘 ${prefix}invite ====> لمعرفة عدد دعواتك 〙
〘 ${prefix}color ====> لوضع لون لك 〙
〘 ${prefix}emoji ====> لرؤية قائمة اموجيات السيرفر 〙
〘 ${prefix}history ====> يعرض لك تاريخ اليوم 〙
〘 ${prefix}roleinfo ====> يوريك معلومات رتبة باسمها او الايدي حقها 〙
〘 ${prefix}say ====> يكرر الكلام الي تكتبه 〙
〘 ${prefix}avatar ====> صورتك او صورة الي تمنشنه 〙
〘 ${prefix}avt ====> يعطيك صورة الشخص عن طريق الايدي 〙
〘 ${prefix}avatar-server ====> صورة السيرفر 〙
〘 ${prefix}user ====> معلومات عنك 〙
〘 ${prefix}new,تيكيت- ====> open ticket support |  يفتح لك تكت 〙
〘 ${prefix}embed ====> يكرر الي تقوله بشكل حلو 〙
〘 ${prefix}rules ====> يعرض لك قوانين السيرفر 〙
〘 ${prefix}inv ====> لدعوة البوت الى سيرفرك 〙
**
`)
   message.author.sendEmbed(embed)
      message.reply('__**تم ارسال الاوامر العامة بالخاص**__')
})
reaction2.on("collect", r => {
      const embed = new Discord.RichEmbed()
  .setThumbnail('https://media.discordapp.net/attachments/756523338259759225/765325522401230898/image2.png?width=481&height=481')
      .setColor("BALCK")
      .setDescription(`
      ✅***__اوامر ادارية__***✅
**
〘 ${prefix}setbots ====> لعمل روم صوتي بعدد البوتات في السيرفر 〙
...
〘 ${prefix}hide ====> اخفاء الشات 〙
〘 ${prefix}talking ====> للتكلم بصفة البوت 〙
〘 ${prefix}count ====> عدد اعضاء السيرفر 〙
〘 ${prefix}setlog ====> لصنع روم اللوق 〙
〘 ${prefix}server ====> يعرض لك معلومات عن السيرفر 〙
〘 ${prefix}mvall,سحب الكل ====> Move all to your room | لسحب الجميع الى رومك 〙
〘 ${prefix}servers-bot ====> لمعرفة سيرفرات البوت 〙
〘 ${prefix}rooms ====> لرؤية رومات السيرفر 〙
〘 ${prefix}all-bots ====> يوريك كل البوتات في سيرفرك 〙
〘 ${prefix}move ====> لسحب عضو الى روم صوتي 〙
〘 ${prefix}giveaway,قيف اواي,ż ====> إنشاء قيف اواي 〙
〘 ${prefix}role,تفضل,رول @mention  ====> لأعطاء رتبة لعضو معين 〙
〘 ${prefix}role all  ====> لأعطاء رتبة للجميع 〙
〘 ${prefix}role humans  ====> لأعطاء رتبة للاشخاص فقط 〙
〘 ${prefix}role bots  ====> لأعطاء رتبة لجميع البوتات 〙
〘 ${prefix}status ====> حالات اعضاء السيرفر 〙
〘 ${prefix}clear,مسح <numbr> ====> clear chat | مسح الشات 〙
〘 ${prefix}mute,اسكت @user <reason> ====> اعطاء العضو ميوت 〙
〘 ${prefix}unmute,تكلم @user ====> لفك الميوت عن الشخص 〙
〘 ${prefix}kick,طرد @user <reason> ====> طرد الشخص من السيرفر 〙
〘 ${prefix}ban,باند @user <reason> ====> ban member | حظر الشخص من السيرفر 〙
〘 ${prefix}unban,فك @user <reason> ====> unban member | حظر الشخص من السيرفر 〙
〘 ${prefix}lock,قفل ===> Lock Chat | تقفيل الشات 〙
〘 ${prefix}unlock,افتح ===> unlock Chat | فتح الشات 〙
〘 ${prefix}addemg  ====> يحط لك صورة الشخص ايموجي 〙
〘 ${prefix}fake  ====> البوت يحط الكلام الي تكتبه 〙
〘 ${prefix}setname  ====> يغير لك اسم السيرفر 〙
〘 ${prefix}ct <name> ====> انشاء شات 〙
〘 ${prefix}cv <name> ====> انشاء رووم فويس 〙
**
`)
   message.author.sendEmbed(embed)
      message.reply('__**تم ارسال الاوامر الإدارية بالخاص**__')
})
reaction3.on("collect", r => {
  const embed = new Discord.RichEmbed()
  .setThumbnail('https://media.discordapp.net/attachments/756523338259759225/765325776778166312/image0.png?width=560&height=481')
      .setColor("BALCK")
      .setDescription(`
       ✅***__اوامر العاب__***✅
 **       
〘 ${prefix}cut ====> لعبة كت تويت 〙
〘 ${prefix}هل تعلم 〙
〘 ${prefix}حكم 〙
〘 ${prefix}جمع 〙
〘 ${prefix}طرح 〙
...
`)
   message.author.sendEmbed(embed)
   message.reply('__**تم ارسال الاوامر الالعاب بالخاص**__')
})
...
.setColor('#ffffff')
.setDescription(`**Please Click Reaction Create Roles ✅**
**Please Click Reaction Cancel Create Roles ❌**
`)
...
let embed = new Discord.RichEmbed()
.setColor('#ffffff')
.setDescription(`**Done Create Rooms | ✅**`)
...
client.on("message", message => {
  if (message.content.startsWith(prefix + "restart")) {
    ...
    client.on('message',async message => {
    if(message.content.startsWith(prefix + "setbots")) {
...
client.on('message', msg => {
    if(msg.content.startsWith('-nt-inv')) {
...
if (msg.content.split(" ")[0].toLowerCase() === "-crcolor") {
...
if(message.guild.id !== "756523122504630423")return;
  ...
  return message.channel.send(
    new Discord.MessageEmbed()
      .setColor("#00BFFF")
      .setTitle("حدث خطأ..")
      .setDescription("رجاء قم بكتابة الاقتراح")
      .setFooter("TinBot Suggestions!")
  )
  let Membed = new Discord.MessageEmbed()
  .setColor("#00BFFF")
.setDescription(`**الاقتراح :**\n\`\`\`${Me}\`\`\``)
.addField(`**من قبل :**`,`<@${message.author.id}>`)
.addField(`**الايدي :**`,`\`\`\`${message.author.id}\`\`\``)
     ...
     .setFooter(`${member.guild.name}`)
      ...
      channel.sendEmbed(embed);
        ...
        client.on('guildMemberRemove', member => {
            ...
            .setThumbnail(member.user.avatarURL)
            .setTitle(`Member out ✋:skin-tone-1: 😔`)
            .setDescription(`Good Bye ✋:skin-tone-1: 😔 `)
            .addField('👤 Your Number is',`**[ ${member.guild.memberCount} ]**`,true)
            .setColor('RED')
...
client.on('message', async(message) => {
if(message.content.startsWith(prefix + 'addem')){
let men = message.mentions.members.first();
if(!men) return message.channel.send(`Pleaase Mention Member To Create Emoji`)
var emoji = await message.guild.createEmoji(men.user.avatarURL,men.id);
message.channel.send(`> **Done Create Emoji**`)
}
});
...
const MeCodes = JSON.parse(fs.readFileSync("./MeCodes.json", "utf8")); //تحديد الروم
client.on("message", message => {
  if (message.author.bot) return;
  if (!message.channel.guild) return;
  if (message.content.startsWith(prefix + "repaly")) {
    if (!message.member.hasPermission("MANAGE_GUILD"))
      return message.channel.send(
        ":information_source: | **لا تملك الصلاحيات الكافيه**"
      );
          ...
          m.edit(" **Ⓜ️ 🇪**").then(m => {
            ...
            m.channel
              ...
              .then(m6 => {
                ...
                m6.delete();
                m.edit("**...جارى الانشاء **").then(mtime => {
                  setTimeout(() => {
                    let MeCodes = new Discord.RichEmbed()
                      .setTitle("**تم انشاء رد تلقائي**")
                      .addField("الرسالة:", scared)
                      .addField("الرد:", reply)
                      .addField("بواسطة:", `${message.author}`)
                      .setFooter(`TinBot.`);
...
.setDescription(`
 **invite TinBot.** [**Invite Me.**](https://discord.com/api/oauth2/authorize?client_id=747949575934967808&permissions=8&scope=bot)
 **Server Support.** [**Server Support.**](https://discord.gg/gJRVzsr)
 **The Main Server.** [**The Main Server.**](https://discord.gg/nBhJacn)
...
if(laith.content === prefix + "help ban") {
let embed = new Discord.RichEmbed()
...
**امثله للأمر**
-ban <@616709497817268281>
-ban <@616709497817268281> سبام
-ban <@616709497817268281> 1h سبام
-ban <@616709497817268281> 1d سبام
-ban <@616709497817268281> 1w`)
.setColor("BLACK")
laith.channel.send(embed).then(m => {
});  
}});
...
client.login("NzQ3OTQ5NTc1OTM0OTY3ODA4.X0WUUw.96Vpcm0jL5mhOJORTqNfrpgm1Lc");